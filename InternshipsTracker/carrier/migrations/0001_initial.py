    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.carrier')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='assignment',
            name='supervisor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.supervisor'),
        ),
        migrations.AddField(
            model_name='assignment',
            name='trainee',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.undergraduatestudent'),
        ),
        migrations.AddField(
            model_name='assignment',
