    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.address', unique=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.address', unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.address', unique=True)),
                ('carrier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='InternshipsApp.carrier')),
            ],
            options={
