...
def password_is_ok(password):
    ...
    """
    is_ok_special_characters = occurences_of_special(
        password) >= settings.PASSWORD_NUMBER_SPECIAL
    is_ok_digits = occurences_of_digits(
        password) >= settings.PASSWORD_NUMBER_DIGITS
